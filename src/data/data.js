...
const allObjects = {
	items: new Map([
		...
		[ 4, 	{ name: 'Box(Gold)', 			priceWhenBuy: 0, 			priceWhenSell: 10_030, 	img: 'box_gold', 				craft: [1, [0, 1], [2, 1]]}],
		...
		[ 9, 	{ name: 'Flower In Vase', priceWhenBuy: 0, 			priceWhenSell: 10, 			img: 'flower_in_vase', 	craft: [1, [7, 1], [8, 1]]}],
		...
		[ 14, { name: 'Fish(RTX)', 			priceWhenBuy: 0, 			priceWhenSell: 15, 			img: 'rtx_fish', 				craft: [1, [6, 1], [16, 1]]}],
		[ 15, { name: 'Fragment(RTX)', 	priceWhenBuy: 0, 			priceWhenSell: 1_000, 	img: 'rtx_fragment', 		craft: null}],
		[ 16, { name: 'Videocard(RTX)', priceWhenBuy: 0, 			priceWhenSell: 50_000, 	img: 'rtx_videocard', 	craft: [1, [17, 1], [15, 10]]}],
